$(document).ready(function(){
	...
	$('.js-sub-menu-toggle + ul > li > a').on('click', function(e){
		//e.preventDefault();
		$li = $(this).parent('li');
		//$('.js-sub-menu-toggle + ul').children().removeClass('active');
		//$li.addClass('active');
		localStorage.setItem("opcion_activa", $li.data('id'));
		//window.location.href = $('.js-sub-menu-toggle + ul > li > a').attr('href');
	});
