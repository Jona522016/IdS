<?php
class traslados_entre_bodegasController extends Controller {
	...
	$this->view->titulo = 'Traslados entre Bodegas';
		$this->view->descripcion = 'Ingreso de la información del Traslado';
...
*/	
		...
		$combo=$this->generarCombo($this->modeloBodega,array('id'=>'bodegaI'));	
		$this->view->bodegaI = $combo['combo'];		
		$combo=$this->generarCombo($this->modeloBodega,array('id'=>'bodegaE'));	
		$this->view->bodegaE = $combo['combo'];
		$combo=$this->generarCombo($this->modeloProducto,array('id'=>'producto','tipo'=>'metadatos'),TRUE);		
		$this->view->producto = $combo['combo'];
		
		$this->view->setJs(array('traslados_entre_bodegas-table','traslados_entre_bodegas'));
		$this->view->rendering('traslados_entre_bodegas');		
	}

	
	public function grabarTraslado(){
		...
		$datos=$_POST['datosDetalleIngreso'];
		...
		$datos1=$_POST['datosDetalleEgreso'];
