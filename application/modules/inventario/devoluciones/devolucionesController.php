...
class devolucionesController extends Controller {
	...
	$this->view->titulo = 'Devoluciones';
		$this->view->descripcion = 'Ingreso de la información de la Devolución';
...
*/	
		...
		$this->view->setJs(array('devoluciones-table','devoluciones'));
		$this->view->rendering('devoluciones');		
	}

	
	public function grabarDevolucion(){
