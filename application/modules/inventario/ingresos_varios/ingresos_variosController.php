<?php
class ingresos_variosController extends Controller {
	...
	$this->view->titulo = 'Ingresos Varios';
		$this->view->descripcion = 'Ingreso de la información deL Ingreso';
...
*/	
		...
		$this->view->setJs(array('ingresos_varios-table','ingresos_varios'));
		$this->view->rendering('ingresos_varios');		
	}
