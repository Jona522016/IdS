$(document).ready(function(){
	...
	function generarGrid(grid){
		if( grid.length > 0 ) {
			grid.jqGrid({
				url: base_url+'catalogos/tipo_unidad_medida/DataTable/id_tipo_unidad_medida'
				,editurl: base_url+"catalogos/tipo_unidad_medida/DataTableEdit/id_tipo_unidad_medida"
				,sortname: 'id_tipo_unidad_medida'
				,shrinkToFit: true
				,autowidth:true
				,colModel:[
					{	name:'select'
