<?php
class asignacion_entidad_grupoModel extends Model{
	
	public function __construct() {
		parent::__construct();
		$this->tabla = "sys_asignacion_entidad_grupo";
		$this->id_tabla = "id_asignacion_entidad_grupo";
		
		$this->campos['id_asignacion_entidad_grupo'] = 0;
