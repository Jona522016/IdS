<?php
class asignacion_entidad_grupoController extends Controller{

	public function __construct(){
		parent::__construct();
		$this->modelo=$this->loadModel('asignacion_entidad_grupo','catalogos');
	...
	public function index(){
		...
		$combo=$this->generarCombo($this->modeloEntidad,array('id'=>'entidad','class'=>'bdual-list','multiple'=>'multiple','no_elegir'=>true));	
		$this->view->entidades = $combo['combo'];	
		
		$this->view->setJs(array('asignacion_entidad_grupo'));		
		$this->view->rendering('asignacion_entidad_grupo');		
	}
