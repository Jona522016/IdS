$(document).ready(function(){
	var dual_list = $('#menu').bootstrapDualListbox({
	...
	$("#entidad").change(function(){
		$.ajax({
			url: base_url+'catalogos/asignacion_menu_entidad/obtener_datos/'+$("#entidad").val()
			,async: true
			,type:'POST'
	...
	$("#aceptar").click(function(){
		...
		$.ajax({
			url: base_url+'catalogos/asignacion_menu_entidad/grabar_datos/'+$("#entidad").val()
			,async: true
			,type:'POST'
			,data:info
			,success: function(data) {
