<?php
class asignacion_menu_entidadController extends Controller{

	public function __construct(){
		parent::__construct();
		$this->modelo=$this->loadModel('asignacion_menu_entidad','catalogos');
	...
	public function index(){
		...
		$combo=$this->generarCombo($this->modeloEntidad,array('id'=>'entidad'));	
		...
		$this->view->setJs(array('asignacion_menu_entidad'));		
		$this->view->rendering('asignacion_menu_entidad');		
	}
	...
	public function grabar_datos($id=false){
		$datos = $_POST;
		$params=array('prepare'=>true,'operacion'=>'delreg','datos'=>array('id_entidad'=>$id));
	...
	public function obtener_datos($id=false){
		$datos = $_POST;
		$params=array('prepare'=>true,'operacion'=>'obtener_datos','datos'=>array('id_entidad'=>$id));
		$resultado = $this->modelo->ejecutarQuery($params);
		echo json_encode($resultado);
	}		
