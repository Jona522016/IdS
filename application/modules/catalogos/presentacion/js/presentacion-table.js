$(document).ready(function(){
	...
	function generarGrid(grid){
		if( grid.length > 0 ) {
			grid.jqGrid({
				url: base_url+'catalogos/presentacion/DataTable/id_presentacion'
				,editurl: base_url+"catalogos/presentacion/DataTableEdit/id_presentacion"
				,sortname: 'id_presentacion'
				,shrinkToFit: false
				,colModel:[
					{	name:'select'
						,label:'Acciones '
