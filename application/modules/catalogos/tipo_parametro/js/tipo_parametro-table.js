$(document).ready(function(){
	...
	function generarGrid(grid){
		if( grid.length > 0 ) {
			grid.jqGrid({
				url: base_url+'catalogos/tipo_parametro/DataTable/id_tipo_parametro'
				,editurl: base_url+"catalogos/tipo_parametro/DataTableEdit/id_tipo_parametro"
				,sortname: 'id_tipo_parametro'
				,shrinkToFit: true
				,autowidth:true
				,colModel:[
					{	name:'select'
